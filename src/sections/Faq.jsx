...
const faqs = [
  ...
  },
  {
    ...
    a: `Pricing scales with scope. Launch landing pages from ₹20k (~$240). Business sites with CMS and SEO from ₹75k (~$900). Sprint custom builds from ₹2L (~$2.5k). Full Pro web platforms from ₹6.5L (~$8k). Enterprise embedded engagements quoted quarterly from ₹25L. Every engagement is fixed-scope with the price agreed upfront — no hourly billing.`
  }
]
